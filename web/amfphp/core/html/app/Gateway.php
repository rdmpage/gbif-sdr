...
require_once(AMFPHP_BASE . "html/app/Actions.php");
...
class Gateway extends BasicGateway
{
	function createBody()
	{
		$GLOBALS['amfphp']['encoding'] = 'html';
		$body = & new MessageBody();
		
		$uri = __setUri();
		$elements = explode('/html.php', $uri);
		
		if(strlen($elements[1]) == 0)
		{
			echo("The HTML gateway is installed correctly. Call like this: html.php/MyClazz.myMethod/arg1/arg2");
			exit();
		}
